...
class ProductAttribute(models.Model):
    ...
    def get_create_product_attribute(self, attr_name_lst, variant_dict, product_template_id):
        ...
        @name : Kamlesh Singh
        @date : 24/10/2024
        @purpose : This method will use for create product attribute
        :param attr_name_lst:
        :param variant_dict:
    ...
    def prepare_and_create_product_attribute(self, list_dict):
        ...
        @name : Kamlesh Singh
        @date : 24/10/2024
        @purpose : This method will use for creating product attribute
        :param list_dict:
        :return: list
        """
        ...
        for attr_dict in list_dict.get("options"):
            ...
            for attr_value in attr_values:
                attribute_value = product_attribute_value_obj.search_or_create_product_attribute_value(
                    attr_value, attribute, is_create_new_attribute_value=True)
                if attribute_value:
    ...
    def prepare_template_attribute_value_domain(self, product_attribute_list, variant_dict, product_template_id):
        ...
        @name : Kamlesh Singh
        @date : 24/10/2024
        @purpose : This method will prepare domain for product template attribute value
        :param product_attribute_list:
        :param variant_dict:
        :param product_template_id:
        :return: domain
        """
    ...
    def search_or_create_product_attribute(self, attribute_name, attribute_type='radio', create_variant='always',
        ...
        @name : Kamlesh Singh
        @date : 24/10/2024
        @purpose : This method will use for search or create product attribute
        :param attribute_name:
        :param attribute_type:
        :param create_variant:
        :param is_create_new_attribute:
        :return:
        """
