...
class SaleOrder(models.Model):
    ...
    def compute_stock_move_count(self):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : Compute stock move count
        :return: None
        """
    ...
    setu_sale_order_automation_id = fields.Many2one(
        comodel_name="setu.sale.order.automation", string="Sale Automation ID")
    ...
    def preparation_of_sale_order_values(self, vals):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will to prepare sale order values
        :param vals:
    ...
    def create_order_process_validation(self):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : When create order from ecommerce check some validation
        :return: True
        """
        for order_id in self:
            ...
            if not order_lines.filtered(lambda l: l.product_id.type == 'consu' and l.product_id.is_storable) and len(order_id.order_line) != len(
    ...
    def _check_fiscal_year_end_date(self):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will use to check fiscal year with end date
        :return: True or False
        """
        journal = self.setu_sale_order_automation_id.sale_journal_id
        lock_date = self.company_id._get_user_fiscal_lock_date(journal=journal)
    ...
    def process_auto_validate_sale_order_confirmation(self):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will use process for auto confirmation and validate sale order
        :return: True
        """
    ...
    def _prepare_invoice(self):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will use to update invoice vals
        :return: invoice vals dictionary
        """
    ...
    def validate_invoice_create_payment(self, sale_order_automation_id):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will use to create invoice payment and validate
        :param sale_order_automation_id:
        :return: True
        """
        self.ensure_one()
        try:
    ...
    def register_invoice_payment(self, work_flow_process_record, move_id):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will use to register invoice payment
    ...
    def in_payment_validate(self, payment_id, move_id):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will use is payment validate then reconcile
        :param payment_id:
        :param move_id:
        :return: True
        """
        ...
        for payment, lines in zip([payment_id], to_reconcile):
            ...
            for account in payment_lines.account_id:
                (payment_lines + lines).filtered_domain([('account_id', '=', account.id), ('reconciled', '=', False),
                                                         ('parent_state', '=', 'posted')]).reconcile()
    ...
    def prepare_payment_vals(self, sale_order_automation_id, invoice_id):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will use to prepare payment vals
        :param sale_order_automation_id:
        :param invoice_id:
        :return: payment vals dictionary
        """
        vals = {
            'journal_id': sale_order_automation_id.journal_id.id,
            'memo': invoice_id.payment_reference,
    ...
    def auto_shipping_order_confirm(self, customer_location_id, is_mrp_module_installed=False):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will use to auto validate shipping
        :param customer_location_id:
        :param is_mrp_module_installed:
        :return: True
        """
    ...
    def check_for_bom_product(self, product_id):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will use to check if bom product
        :param product_id:
        :return:
        """
        try:
    ...
    def auto_create_and_validate_stock_move(self, order_line, customer_location_id, bom_line=False,
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will use to auto create and validate stock move
        :param order_line:
        :param customer_location_id:
        :param bom_line:
        :param supplier_location_id:
        :return: True
        """
        if bom_line:
    ...
    def action_view_stock_move(self):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will use to show stock moves
        :return: action
        """
        stock_move_obj = self.env['stock.move']
    ...
    def check_product_dropship(self, product_id):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will use to check is dropship product
        :param product_id:
        :return: True or False
        """
