...
class ResPartner(models.Model):
    ...
    def partner_search_by_email(self, email):
        ...
        @name : Kamlesh Singh
        @date : 25/10/2024
        @purpose : This method will use for search partner by email
        :param email:
    ...
    def find_odoo_country(self, country_info):
        ...
        @name : Kamlesh Singh
        @date : 25/10/2024
        @purpose : This method will use to find partner based on information
        :param country_info:
    ...
    def find_odoo_country_state(self, country_info, state_info, country_id=False):
        ...
        @name : Kamlesh Singh
        @date : 25/10/2024
        @purpose : This method will use to find state based on information
        :param country_info:
        :param state_info:
        :param country_id:
        :return: state record
    ...
    def _available_erp_partner(self, partner_vals, address_list, extra_where_clause=[]):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will check partner is available in erp
        :param partner_vals:
        :param address_list:
    ...
    def search_partner_by_email_phone(self, res_partner, email, phone):
        ...
        @name : Kamlesh Singh
        @date : 28/10/2024
        @purpose : This method will use search partner by email or phone
        :param res_partner:
        :param email:
        :param phone:
        :return: partner record
