{
    ...
    'data': ['security/security.xml',
             ...
             'views/setu_inventory_count_settings_views.xml',
             'views/stock_move_line_views.xml',
             'views/stock_move_views.xml',

             'report_views/setu_inventory_count_report_views.xml',
             'report_views/setu_inventory_adjustment_report_views.xml',
             'report_views/setu_inventory_count_valuation_report_views.xml',
             'report_views/setu_inventory_user_states_report_views.xml',
    ...
    'assets': {
        'web.assets_backend': [
            'setu_inventory_count_management/static/src/scss/*',
        ],
    },
