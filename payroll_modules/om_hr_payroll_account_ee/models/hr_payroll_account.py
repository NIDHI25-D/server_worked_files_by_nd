...
class HrPayslipLine(models.Model):
    ...
    def _get_partner_id(self, credit_account):
        ...
        """
            ...
            Date: 11/08/25
            Task: Partner is not assigned to the Payroll Entry { https://app.clickup.com/t/86dxfc69p }
            Purpose: MODIFY THIS METHOD BECAUSE IF account_type NOT IN LIST IT WILL RETURN FALSE 
        """
