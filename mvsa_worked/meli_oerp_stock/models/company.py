...
class ResCompany(models.Model):
    ...
    mercadolibre_stock_pick_type = fields.Selection([('specific', 'Specific'),
                                                     ('several', 'Several')],
                                                    string="Default Stock Location", default="specific")
    meli_warehouse_ids = fields.One2many('meli.warehouse', 'company_id')
    #*#
