...
class res_config_settings(models.TransientModel):
    ...
    audit_user = fields.Char('Audit User Email')
    ...
    def get_values(self):
        ...
        user = config_parameter_obj.get_param('advanced_session_management.audit_user', False)
        res.update(audit_user=user)
    ...
    def set_values(self):
        ...
        config_parameter_obj.set_param('advanced_session_management.audit_user', self.audit_user or False)
