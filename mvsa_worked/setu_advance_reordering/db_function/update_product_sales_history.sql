		...
		i1 as
			...
			Insert into product_sales_history
                    (product_id, warehouse_id, orderpoint_id,sales_qty, average_daily_sale, max_daily_sale_qty,
					 ...
					 write_date, create_uid, write_uid,actual_sales_qty, actual_sales_return_qty, sales_days)
--					 actual_sales_return_qty
                    Select
						rd.product_id,
						rd.warehouse_id,
						rd.orderpoint_id,
						...
						rd.t_sales_qty,rd.t_sales_return_qty, rd.sales_day
