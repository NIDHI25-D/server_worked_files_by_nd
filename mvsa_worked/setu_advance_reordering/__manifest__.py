...
# Part of Odoo. See LICENSE file for full copyright and licensing details.
{
    ...
    'depends': ['setu_intercompany_transaction', 'website_sale', 'setu_website_preorder'],  # 'stock', 'purchase',
    'license': 'OPL-1',
    'sequence': 26,
    'data': [
        ...
        'db_function/get_out_of_stock_data_day_wise.sql',
        'data/ir_cron.xml',
        'wizard/establish_po_type_wiz_view.xml',
        'wizard/remove_products_from_template_wiz_view.xml',
    ],
    'application': True,
