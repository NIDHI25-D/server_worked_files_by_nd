...
class ConvertHtmlText(object):
    ...
    def convert_html_to_text(result_txt):
        """
            ...
            Purpose: This method converts html to text
        """
        # capt = b'%s' % (result_txt)
...
class SendWhatsappInvoice(models.TransientModel):
    ...
    def _onchange_message(self):
        """
            ...
            Date: 10/5/23
            Task: Migration from v14 to v16
            Purpose: This method is called when message is changed which is depended on quick replies.
                    Then message is converted from html to txt(data) and lastly a message is prepared.
        """
    ...
    def close_dialog(self):
        """
            ...
            Date: 10/5/23
            Task: Migration from v14 to v16
            Purpose: This method is used to close the dialog automatically once the mail is sent.
        """
    ...
    def sending_confirmed(self):
        """
            ...
            Date: 10/5/23
            Task: Migration from v14 to v16
            Purpose: This method is used to send the confirmation
        """
    ...
    def sending_error(self):
        """
            ...
            Date: 10/5/23
            Task: Migration from v14 to v16
            Purpose: This method is used to send an error, if user's country code or somehow not able to send,also update the state
        """
    ...
    def send_whatsapp(self):
        """
            ...
            Date: 10/5/23
            Task: Migration from v14 to v16
            Purpose: This method is used to send the message via whatsapp, it will also open a new tab of web.whatsapp.
                    Here it will also check if message , mobile or broadcast are given or not
        """
        validation = self.env['whatsapp.mixin'].send_validation_broadcast(self.mobile, self.message, False)
