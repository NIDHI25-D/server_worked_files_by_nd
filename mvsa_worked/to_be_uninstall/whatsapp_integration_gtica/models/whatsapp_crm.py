...
class SendWhatsappCRM(models.TransientModel):
    ...
    def _onchange_price_list(self):
        """
            ...
            Purpose: THis method is executed when the price-list of the whatsapp wizard is changed.It will get the data as per the product.categories
        """
        if self.price_list:
    ...
    def default_get(self, fields):
        """
            ...
            Date: 10/05/23
            Task: Migration from V14 to v16
            Purpose: This method is to set default data of crm in whatsapp wizard
        """
    ...
    def close_dialog(self):
        """
            ...
            Date:10/5/23
            Task:  Migration from v14 to v16
            Purpose: This method is used to close dialog once message is sent via whatsapp
        """
    ...
    def sending_confirmed(self):
        """
            ...
            Date:10/5/23
            Task: Migration from v14 to v16
            Purpose: This method is used to open web.whatsapp and send message as well as close the dialog
        """
