    ...
    BEGIN
        ...
        (
            Select
                ...
                coalesce(ls.cost_price,0) as cost_price
            From
            (
                Select
        ...
        case
            when
                stock_data.forecasted_stock > 0.00 and coalesce(sales_data.ads, 0) = 0.00 then advance_stock_days
            when
            ...
            case when T.forecasted_stock > 0 then T.forecasted_stock else 0 end as forecasted_stock
                ...
                Left join LATERAL get_product_company_dependent() as ls ON ls.product_id= final_data.product_id and ls.company_id = final_data.company_id
