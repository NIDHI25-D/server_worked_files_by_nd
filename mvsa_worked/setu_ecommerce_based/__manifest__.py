{
    ...
    # Dependencies
    'depends': ['delivery', 'sale_stock', 'account', 'sale_management', 'stock_delivery'],
    ...
    'data': ['security/setu_ecommerce_based_security.xml',
             ...
             'wizard/setu_ecommerce_import_export_process_wiz_views.xml',
             'wizard/setu_cron_configuration_wiz_views.xml',
             'views/setu_generic_product_image_views.xml',
             'views/stock_quant_views.xml',
             'wizard/setu_ecommerce_process_chain_wiz_views.xml',
             'wizard/setu_ecommerce_product_export_wiz_views.xml',
