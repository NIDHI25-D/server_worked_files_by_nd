...
class SetuEcommerceProcessChainWiz(models.TransientModel):
    ...
    def manual_main_chain_process(self):
        ...
        @name : Kamlesh Singh
        @date : 29/10/2024
        @purpose : This method will process for main chain process
        :return: True
        """
    ...
    def manual_product_chain_process(self):
        ...
        @name : Kamlesh Singh
        @date : 29/10/2024
        @purpose : This method will process for product chain process
        :return: True
        """
    ...
    def manual_customer_chain_process(self):
        ...
        @name : Kamlesh Singh
        @date : 29/10/2024
        @purpose : This method will process for customer chain process
        :return: True
        """
    ...
    def manual_order_chain_process(self):
        ...
        @name : Kamlesh Singh
        @date : 29/10/2024
        @purpose : This method will process for order chain process
        :return: True
        """
    ...
    def cancel_main_chain_process(self):
        ...
        @name : Kamlesh Singh
        @date : 29/10/2024
        @purpose : This method will cancel main chain process
        :return: True
        """
        get_current_chain_process = self._context.get('current_chain_process')
    ...
    def cancel_order_chain_process(self):
        ...
        @name : Kamlesh Singh
        @date : 29/10/2024
        @purpose : This method will cancel order chain process
        :return: True
        """
    ...
    def cancel_product_chain_process(self):
        ...
        @name : Kamlesh Singh
        @date : 29/10/2024
        @purpose : This method will cancel product chain process
        :return: True
        """
    ...
    def cancel_customer_chain_process(self):
        ...
        @name : Kamlesh Singh
        @date : 29/10/2024
        @purpose : This method will cancel customer chain process
        :return: True
        """
