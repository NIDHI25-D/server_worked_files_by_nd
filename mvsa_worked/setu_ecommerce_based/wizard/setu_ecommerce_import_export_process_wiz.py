...
class SetuEcommerceImportExportProcessWiz(models.TransientModel):
    ...
    def ecommerce_perform_operation(self):
        ...
        @name : Kamlesh Singh
        @date : 29/10/2024
        @purpose : Perform ecommerce operation like import product, customer, order etc...
        :return: True
        """
    ...
    def manual_export_product_to_ecommerce(self):
        ...
        @name : Kamlesh Singh
        @date : 29/10/2024
        @purpose : This method will use to export product to ecommerce like shopify, woocommerce etc...
        :return: True
        """
        if hasattr(self,
    ...
    def manual_update_product_to_ecommerce(self):
        ...
        @name : Kamlesh Singh
        @date : 29/10/2024
        @purpose : This method will use to update product to ecommerce like shopify, woocommerce etc...
        :return: True
        """
    ...
    def cron_auto_update_order_status_in_ecommerce(self, ctx):
        ...
        @name : Kamlesh Singh
        @date : 29/10/2024
        @purpose : This method will use to update order status to ecommerce like shopify, woocommerce etc...
        :param ctx:
        :return: True
        """
    ...
    def action_generic_export_update_process(self):
        ...
        @name : Kamlesh Singh
        @date : 29/10/2024
        @purpose : This method will use to export update generic to ecommerce like category, tags, coupon etc...
        :return: True
        """
        multi_ecommerce_connector_id = self.env[self._context.get('active_model')].browse(
            self._context.get('active_id')).multi_ecommerce_connector_id
    ...
    def cron_auto_update_stock_in_ecommerce(self, ctx):
        ...
        @name : Kamlesh Singh
        @date : 29/10/2024
        @purpose : This method will use to update stock in ecommerce
        :param ctx:
        :return: True
        """
        setu_multi_ecommerce_connector_obj = self.env['setu.multi.ecommerce.connector']
