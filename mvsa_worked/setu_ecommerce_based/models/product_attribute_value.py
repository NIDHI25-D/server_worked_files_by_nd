...
class ProductAttributeValue(models.Model):
    ...
    def prepare_template_attribute_values(self, variation_attributes, product_template):
        ...
        @name : Kamlesh Singh
        @date : 24/10/2024
        @purpose : This method will prepare product attribute value in list
    ...
    def search_or_create_product_attribute_value(self, name, attribute_id, is_create_new_attribute_value=False):
        ...
        @name : Kamlesh Singh
        @date : 24/10/2024
        @purpose : This method will use for search or creating product attribute value
        :param name:
        :param attribute_id:
        :param is_create_new_attribute_value:
        :return: recordset product attribute value
        """
