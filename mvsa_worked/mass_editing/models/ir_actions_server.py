...
class IrActionsServer(models.Model):
    ...
    def _onchange_model_id(self):
        ...
        Purpose: This method will used to clear mass_edit_line_ids
        :return:
        """
    ...
    def _check_field_model(self):
        ...
        Date: 11/02/2025
        Task: [1571] Mass Editing (Migration)
        Purpose: Check that all fields belong to the model
        :return: No
        """
    ...
    def _compute_mass_edit_apply_domain_in_lines(self):
        ...
        Date: 11/02/2025
        Task: [1571] Mass Editing (Migration)
        Purpose: This method will used to set true or false if any apply domain in mass edit line 
        :return: None
        """
        for record in self:
    ...
    def _run_action_mass_edit_multi(self, eval_context=None):
        ...
        Date: 11/02/2025
        Task: [1571] Mass Editing (Migration)
        Purpose: Show report label wizard
        :param eval_context: 
        :return: dictionary
        """
        ...
        view_id = self.env.ref("mass_editing.view_mass_editing_wizard_form")
