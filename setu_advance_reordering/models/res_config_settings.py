...
class ResConfigSettings(models.TransientModel):
    ...
    days_to_consider_purchase_history = fields.Integer("Days to consider purchase history",
                                                       config_parameter='setu_advance_reordering.days_to_consider_purchase_history')
