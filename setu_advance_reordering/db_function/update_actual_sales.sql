...
BEGIN
    ...
    from (
            ...
            (
                Select S.product_id,S.warehouse_id,S.product_qty as product_qty from get_stock_data_ar(null,product_ids,null,warehouse_ids,'sales',start_date,end_date)S
                UNION ALL
                Select SR.product_id,SR.warehouse_id,SR.product_qty * -1 as product_qty from get_stock_data_ar(null,product_ids,null,warehouse_ids,'sales_return',start_date,end_date)SR
