...
class SendWhatsappSale(models.TransientModel):
    ...
    def _onchange_price_list(self):
        """
            ...
            Purpose: This method is called when there is any change in pricelist of the whatsapp wizard
        """
        if self.price_list:
    ...
    def _onchange_message(self):
        """
            ...
            Date: 10/05/23
            Task: Migration from V14 to V16
            Purpose: This method is called when there is any change in the message of the whatsapp
        """
        sale_order_id = self.env['sale.order'].browse(self._context.get('active_id'))
